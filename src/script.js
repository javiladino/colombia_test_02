...
scene.background = new THREE.Color(0x0a1d41)
...
loader.load('models/gltf/colombia_03.glb', function (gltf) {
...
function introAnimation() {
    ...
    new TWEEN.Tween(camera.position.set(0, 5, 12 )).to({ // from camera position
        x: 16, //desired x position to go
        y: 20, //desired y position to go
        z: 25 //desired z position to go
